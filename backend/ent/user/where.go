...
// HasIssuesCreated applies the HasEdge predicate on the "issuesCreated" edge.
func HasIssuesCreated() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(IssuesCreatedTable, FieldID),
...
// HasIssuesCreatedWith applies the HasEdge predicate on the "issuesCreated" edge with a given conditions (other predicates).
