...
// AddIssuesCreated adds the "issuesCreated" edges to the Issue entity.
...
// ClearIssuesCreated clears all "issuesCreated" edges to the Issue entity.
func (uu *UserUpdate) ClearIssuesCreated() *UserUpdate {
	uu.mutation.ClearIssuesCreated()
	return uu
}

// RemoveIssuesCreatedIDs removes the "issuesCreated" edge to Issue entities by IDs.
func (uu *UserUpdate) RemoveIssuesCreatedIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveIssuesCreatedIDs(ids...)
	return uu
}

// RemoveIssuesCreated removes "issuesCreated" edges to Issue entities.
